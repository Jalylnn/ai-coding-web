/**
 * 思维导图数据 — 客户端直接引用（用于静态部署）
 * 与 server/src/data/mindmaps.ts 保持一致
 */

import type { MindmapData, MindmapSummary } from '../../shared/types.js';
...
export const mindmaps: MindmapData[] = [
    {
        ...
        root: {
            ...
            children: [
                {
                    id: 'flow-plan', label: 'PLAN 规划', icon: '📋', color: '#8b5cf6',
                ...
                {
                    id: 'flow-code', label: 'AI 编写代码', icon: '🤖', color: '#06b6d4',
                ...
                {
                    id: 'flow-debug', label: '调试排错', icon: '🔍', color: '#f59e0b',
                ...
                {
                    id: 'flow-git', label: 'Git 管理', icon: '📦', color: '#10b981',
                ...
                {
                    id: 'flow-deploy', label: '部署上线', icon: '🌐', color: '#ef4444',
                    description: '让别人也能访问',
                    children: [
    ...
    },
    {
        ...
        root: {
            ...
            children: [
                {
                    id: 'plan-req', label: '需求描述', icon: '💡', color: '#a78bfa',
                    children: [
                ...
                {
                    id: 'plan-tech', label: '技术选型', icon: '⚙️', color: '#7c3aed',
                    children: [
                ...
                {
                    id: 'plan-dir', label: '目录规划', icon: '📁', color: '#6d28d9',
                    children: [
                ...
                {
                    id: 'plan-split', label: '文件拆分', icon: '✂️', color: '#5b21b6',
                    children: [
                ...
                {
                    id: 'plan-prompt', label: '提示词技巧', icon: '💬', color: '#4c1d95',
                    children: [
    ...
    },
    {
        ...
        root: {
            ...
            children: [
                {
                    id: 'git-what', label: 'Git 是什么', icon: '❓', color: '#34d399',
                    children: [
                ...
                {
                    id: 'git-platform', label: 'GitHub vs GitLab', icon: '🏠', color: '#059669',
                    children: [
                ...
                {
                    id: 'git-pushpull', label: '推/拉代码', icon: '🔄', color: '#047857',
                    children: [
                ...
                {
                    id: 'git-branch', label: '分支管理', icon: '🌿', color: '#065f46',
                    children: [
                ...
                {
                    id: 'git-tag', label: 'Tag 版本管理', icon: '🏷️', color: '#064e3b',
                    children: [
    ...
    },
    {
        ...
        root: {
            ...
            children: [
                {
                    id: 'net-local', label: 'localhost 本机', icon: '💻', color: '#f87171',
                    children: [
                ...
                {
                    id: 'net-lan', label: '局域网', icon: '🏠', color: '#dc2626',
                    children: [
                ...
                {
                    id: 'net-public', label: '公网', icon: '🌍', color: '#b91c1c',
                    children: [
                ...
                {
                    id: 'net-help', label: '找研发帮忙', icon: '🤝', color: '#991b1b',
                    children: [
                ...
                {
                    id: 'net-netlify', label: 'Netlify 部署', icon: '🚀', color: '#7f1d1d',
                    children: [
    ...
    },
    {
        ...
        root: {
            ...
            children: [
                {
                    id: 'review-persist', label: '数据持久化', icon: '💾', color: '#fbbf24',
                    children: [
                ...
                {
                    id: 'review-modular', label: '模块化设计', icon: '🧩', color: '#f59e0b',
                    children: [
                ...
                {
                    id: 'review-scale', label: '扩展性规划', icon: '📐', color: '#d97706',
                    children: [
                ...
                {
                    id: 'review-check', label: '检查清单', icon: '✅', color: '#b45309',
                    children: [
    ...
    },
    {
        ...
        root: {
            ...
            children: [
                {
                    id: 'adv-ts', label: 'TypeScript', icon: '🔷', color: '#22d3ee',
                    children: [
                ...
                {
                    id: 'adv-pg', label: 'PostgreSQL', icon: '🐘', color: '#0891b2',
                    children: [
                ...
                {
                    id: 'adv-linux', label: 'Linux Shell', icon: '🐧', color: '#0e7490',
                    children: [
                ...
                {
                    id: 'adv-more', label: '学习建议', icon: '📚', color: '#155e75',
                    children: [
...
export function getMindmapList(): MindmapSummary[] {
    return mindmaps.map(({ id, title, subtitle, icon }) => ({ id, title, subtitle, icon }));
}
